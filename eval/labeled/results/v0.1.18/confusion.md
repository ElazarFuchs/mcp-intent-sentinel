# Labeled-corpus confusion — MIS v0.1.17, 2026-05-25T14:36:19Z

**N**: 17 labeled rows (13 threat, 1 benign).
**Precision** (on threat verdicts): 1.0

## Recall (split — see L20/L21)

- **synthetic_recall: 1.0**  (12/12, N=12; coverage-gaps=0, errors=0)
...
|---|---:|---|
| TP | 12 | label malicious/suspicious  →  MIS verdict malicious/suspicious |
...
| `fixture:auth_override_pre_authorized` | synthetic | malicious | malicious | TP | 1 | 0.95 |
| `fixture:unicode_steg_description` | synthetic | malicious | malicious | TP | 1 | 0.95 |
